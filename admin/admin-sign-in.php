					...
					<div class="row g-0">
						...
						<div class="col-lg-6 order-1">
							<div class="p-4 p-sm-7">
								...
								<p class="mb-0">Not an Admin?<a href="../sign-in.php"> Customer Login</a></p>
		
								<!-- Form START -->
								<form method="POST" class="mt-4 text-start" action="../includes/admin/login.inc.php">
									<!-- Email -->
									<div class="mb-3">
										<label for="user_id" class="form-label">Enter E-mail ID / Username</label>
