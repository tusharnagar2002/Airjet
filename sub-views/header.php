			...
			<div class="navbar-collapse collapse" id="navbarCollapse">
				...
				<ul class="navbar-nav navbar-nav-scroll align-items-center ms-xl-auto">
						...
						<ul class="dropdown-menu" aria-labelledby="listingMenu">
							...
							<li class="dropdown-submenu dropend">
								...
								<ul class="dropdown-menu" data-bs-popper="none">
									<li> <a class="dropdown-item" href="one-way.php">One Way</a></li>
									<li> <a class="dropdown-item" href="round-trip.php">Round Trip</a></li>								
								</ul>
							</li>
							<li class="dropdown-submenu dropend">
								<a class="dropdown-item" href="gift-voucher.php">Gift Voucher</a>
							</li>
						</ul>
					</li>
					<!-- Nav item Check-In -->
					...
					<li class="nav-item ms-3 dropdown">
						<!-- Avatar -->
						<a class="bi bi-person-circle fs-4 text-white" style="margin-right: 30px;" id="profileDropdown" role="button" data-bs-auto-close="outside" data-bs-display="static" data-bs-toggle="dropdown" aria-expanded="false"></a>
						...
						<ul class="dropdown-menu dropdown-animation dropdown-menu-end shadow pt-3" aria-labelledby="profileDropdown">
							...
							<li class="px-3 mb-3">
								<div class="d-flex align-items-center">
									...
									<div>
										<a class="h6 mt-2 mt-sm-0" href="#">'.$_SESSION['userUid'].'</a>
										<p class="small m-0">'.$_SESSION['userMail'].'</p>
									</div>
								</div>
							</li>
							...
							<li><a class="dropdown-item" href="my-bookings.php"><i class="bi bi-bookmark-check fa-fw me-2"></i>My Bookings</a></li>
							<li><a class="dropdown-item" href="#"><i class="bi bi-heart fa-fw me-2"></i>My Wishlist</a></li>
							<li><a class="dropdown-item" href="#"><i class="bi bi-gear fa-fw me-2"></i>Settings</a></li>
							<li><a class="dropdown-item" href="#"><i class="bi bi-info-circle fa-fw me-2"></i>Help Center</a></li>
							<li><a class="dropdown-item bg-danger-soft-hover" href="includes/logout.inc.php"><i class="bi bi-power fa-fw me-2"></i>Logout</a></li>
							<li> <hr class="dropdown-divider"></li>
						</ul>
					</li> ';
                    } else {
