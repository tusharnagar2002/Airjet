          ...
          <h1 class="text-center ">PAY INVOICE</h1>
            ...
            <div class="icon-container">
              <ul class="list-inline mb-0 mt-3">
                <li class="list-inline-item"> <a href="https://www.rupay.co.in/"><img src="assets/images/element/rupay.svg" class="h-30px" alt=""></a></li>
                <li class="list-inline-item"> <a href="https://www.visa.co.in/"><img src="assets/images/element/visa.svg" class="h-30px" alt=""></a></li>
                <li class="list-inline-item"> <a href="https://www.mastercard.co.in/"><img src="assets/images/element/mastercard.svg" class="h-30px" alt=""></a></li>
                <li class="list-inline-item"> <a href="https://www.americanexpress.com/"><img src="assets/images/element/expresscard.svg" class="h-30px" alt=""></a></li>
              </ul>
            </div>
            <hr>
                        ...
                        <div class="row">
                            ...
                            <div class="col pr-0">                            
                                ...
                                <div class="input-group-append">
                                    ...
                                    data-content="<div class='text-center one-card'>The 3 digit code on the back of the card.<div class='visa-mc-cvc-preview'></div></div>"
